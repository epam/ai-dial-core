...
@Command(
        ...
        subcommands = {RouteCommand.Get.class, RouteCommand.List.class, RouteCommand.Add.class,
                RouteCommand.Update.class, RouteCommand.Delete.class, RouteCommand.Validate.class,
...
public class RouteCommand {
    ...
    @Command(name = "add", description = "Create a route (PUT with If-None-Match: *). Fails with exit 5 if it already exists.")
