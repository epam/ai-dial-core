...
public class SettingsCommand {
    ...
    static class Get implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            EntityReadOps.readSingleton(cmd.parent, spec, TYPE, NAME);
            return 0;
        }
    }
    ...
    static class Update implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            EntityWriter.updateEntity(cmd.parent.toCliOptionsDto(), spec, TYPE, BUCKET, CANONICAL_ID, sets, ifMatch);
            return 0;
        }
    }
    ...
    static class Delete implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            EntityWriter.deleteEntity(cmd.parent.toCliOptionsDto(), spec, TYPE, BUCKET, CANONICAL_ID, ifMatch);
            return 0;
        }
    }
    ...
    static class Validate implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            return EntityWriter.validateEntity(cmd.parent.toCliOptionsDto(), spec, TYPE, KIND, BUCKET, CANONICAL_ID, fromFile, template, params);
        }
    }
    ...
    static class Promote implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            return EntityWriter.promoteEntity(cmd.parent.toCliOptionsDto(), spec, TYPE, KIND, BUCKET, CANONICAL_ID,
    ...
    static class Diff implements Callable<Integer> {
        ...
        @Override
        public Integer call() {
            EntityDiff.runSingleton(cmd.parent.toCliOptionsDto(), spec, TYPE, sourceEnv, targetEnv, NAME);
            return 0;
        }
    }
}
