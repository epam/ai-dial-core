...
@Command(
        ...
        subcommands = {RoleCommand.Get.class, RoleCommand.List.class, RoleCommand.Add.class,
                RoleCommand.Update.class, RoleCommand.Delete.class, RoleCommand.Validate.class,
