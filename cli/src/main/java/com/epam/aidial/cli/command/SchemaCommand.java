...
@Command(
        name = "schema",
        description = "Manage DIAL schema entities.",
        mixinStandardHelpOptions = true,
        subcommands = {SchemaCommand.Get.class, SchemaCommand.List.class, SchemaCommand.Add.class,
                SchemaCommand.Update.class, SchemaCommand.Delete.class, SchemaCommand.Validate.class,
