...
@Command(
        ...
        subcommands = {ApplicationCommand.Get.class, ApplicationCommand.List.class, ApplicationCommand.Add.class,
                ApplicationCommand.Update.class, ApplicationCommand.Delete.class, ApplicationCommand.Validate.class,
...
public class ApplicationCommand {
    ...
    @Command(name = "diff",
            description = "Structural diff of a single application between two environments.")
    static class Diff implements Callable<Integer> {
        ...
        String targetEnv;
        @Option(names = "--name", required = true, description = "Application name or canonical id (applications/<bucket>/<name>).")
        String name;
