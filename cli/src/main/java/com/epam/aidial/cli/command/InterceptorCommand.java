...
@Command(
        ...
        subcommands = {InterceptorCommand.Get.class, InterceptorCommand.List.class, InterceptorCommand.Add.class,
                InterceptorCommand.Update.class, InterceptorCommand.Delete.class, InterceptorCommand.Validate.class,
...
public class InterceptorCommand {
    ...
    @Command(name = "get",
            description = "Get a single interceptor. Pass a canonical id (interceptors/<bucket>/<name>) for API-managed entities, or a plain name for file-config entities.")
    ...
    @Command(name = "list", description = "List interceptors from all sources (API-managed and file-config).")
    ...
    @Command(name = "add", description = "Create an interceptor (PUT with If-None-Match: *). Fails with exit 5 if it already exists.")
