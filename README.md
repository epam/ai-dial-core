...
| keys                            | API Keys parameters:<br />`<core_key>`: Your API key. Refer to [API Keys Roles and Limits]([https://github.com/epam/ai-dial/blob/main/docs/Deployment/idp-configuration/auth0.md](https://github.com/epam/ai-dial/blob/main/docs/tutorials/roles-management.md)) to learn more.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| roles                           | API key or user roles. Each role may have limits to be associated with applications, models, assistants or addons. Refer to [API Keys Roles and Limits]([https://github.com/epam/ai-dial/blob/main/docs/Deployment/idp-configuration/auth0.md](https://github.com/epam/ai-dial/blob/main/docs/tutorials/roles-management.md)) to learn more.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
