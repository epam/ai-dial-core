...
- Implement the **`config.reload.onInvalidEntity: skip | abort`** static setting (default `skip`). See [`02-architecture.md`](02-architecture.md) §4.1.
