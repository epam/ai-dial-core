...
GET    /v1/settings/platform/global                   # Get global settings
PUT    /v1/settings/platform/global                   # Replace global settings (always exists post-bootstrap; upsert)
