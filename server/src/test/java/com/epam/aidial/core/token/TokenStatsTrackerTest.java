...
public class TokenStatsTrackerTest {
    ...
    public void beforeEach() throws JsonProcessingException {
        ...
        String resourceConfig = """
                ...
                """;
        ResourceService resourceService = new ResourceService(mock(ScheduledService.class),
                redissonClient, blobStorage, lockService, ProxyUtil.MAPPER.readTree(resourceConfig), null);
    ...
    public void testWorkflow() {
        ...
        ProxyContext chatBackend = Mockito.mock(ProxyContext.class);
        ...
        ProxyContext app = Mockito.mock(ProxyContext.class);
