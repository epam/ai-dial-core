...
public class ApplicationService {
    ...
    public Application deployApplication(ProxyContext context, ResourceDescription resource) {
        verifyApplication(resource);
    ...
    public Application undeployApplication(ResourceDescription resource) {
        verifyApplication(resource);
        controller.verifyActive();
