...
public class EncryptionService {
    ...
    public EncryptionService(JsonNode settings) {
        if (settings.has("password") || settings.has("salt")) {
        ...
        this.key = getSecretKey(settings.get("secret").asText(), settings.get("key").asText());
    }
